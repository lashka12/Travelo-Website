...
if(!isset($_SESSION['addedCarReview'])&&!isset($_SESSION['addedCarComment'])){

    $_SESSION['carNumber']=$_GET['carIdForReviews'];
...
?>
 ...
 <head>
   ...
   <body>
     ...
     <div class="container">
     <h1 style="text-align:center;color:white;font-weight:bold;">Car Reviews</h1>
     </div>
     </section>
<br>

<div class="container">
<button  id="tstBtn" type="button" class="btn btn-success" data-toggle="modal" data-target="#carNewReviewModal">
...
var items='';
$.getJSON("getCarFeedBack.php",function(data){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="commentForm" action="addCommentToCarReview.php" method="get">
...
<!-- Modal -->
<div class="modal fade" id="carNewReviewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
      ...
      <div class="modal-body">
        ...
        <form id="carNewReviewForm" action="addCarReview.php" method="get">
        <label for="comment">Write Your review</label>
        <textarea class="form-control" name="review"></textarea>
        <br>
        <label for="comment">Grade the Car From 1-5</label>
        <br>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" form="carNewReviewForm">Save changes</button>
      </div>
    </div>
  </div>
</div>
